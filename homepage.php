...
<body>
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                <div class="slide-img bg-img" style="background-image: url(images_1/1.jpg);"></div>
                <div class="container">
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                <div class="slide-img bg-img" style="background-image: url(images_1/3.jpg);"></div>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                <div class="slide-img bg-img" style="background-image: url(images_1/5.jpg);"></div>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
    ...
    <section class="pool-area section-padding-100 bg-img bg-fixed" style="background-image: url(images_1/about.jpg);">
        <div class="container">
    ...
    <section class="rooms-area section-padding-100-0">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-rooms-area wow fadeInUp" data-wow-delay="100ms">
                        <div class="bg-thumbnail bg-img" style="background-image: url(images_1/r4.jpg);"></div>
                        <p class="price-from">From 1000/-night</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-rooms-area wow fadeInUp" data-wow-delay="300ms">
                        <div class="bg-thumbnail bg-img" style="background-image: url(images_1/g4.jpg);"></div>
                        <p class="price-from">From 1500/-night</p>
                        <div class="rooms-text">
                            <div class="line"></div>
                            <h4>Double Room</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada lorem maximus mauris sceleri sque.</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-rooms-area wow fadeInUp" data-wow-delay="500ms">
                        <div class="bg-thumbnail bg-img" style="background-image: url(images_1/r1.jpg);"></div>
                        <p class="price-from">From 2000/-night</p>
                        <div class="rooms-text">
                            <div class="line"></div>
                            <h4>Triple Room</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada lorem maximus mauris sceleri sque.</p>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-rooms-area wow fadeInUp" data-wow-delay="100ms">
                        <div class="bg-thumbnail bg-img" style="background-image: url(images_1/g6.jpg);"></div>
                        <p class="price-from">From 3000/-night</p>
                        <div class="rooms-text">
                            <div class="line"></div>
                            <h4>Family Room</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada lorem maximus mauris sceleri sque.</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-rooms-area wow fadeInUp" data-wow-delay="300ms">
                        <div class="bg-thumbnail bg-img" style="background-image: url(images_1/g10.jpg);"></div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-rooms-area wow fadeInUp" data-wow-delay="500ms">
                        <div class="bg-thumbnail bg-img" style="background-image: url(images_1/g2.jpg);"></div>
                        <p class="price-from">From 6500/night</p>
                        <div class="rooms-text">
                            <div class="line"></div>
                            <h4>Master Suite</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada lorem maximus mauris sceleri sque.</p>
    ...
    <section class="contact-area d-flex flex-wrap align-items-center">
        <div class="contact-info">
            ...
            <h4 class="wow fadeInUp" data-wow-delay="300ms">Sanonda Point- Coxs Bazar, Chittagong, Bangladesh</h4>
            <h5 class="wow fadeInUp" data-wow-delay="400ms">+880-1234-567890</h5>
            <h5 class="wow fadeInUp" data-wow-delay="500ms">moonvalley@hotel.com</h5>
